                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class='slider-dots-fill-primary text-center lkslkls' id="lightgallery">
                            ...
                            <a href="http://caestus.ma/uploads/media/3HlaM37RsHHaJBoQNmLM.jpg"><img
                                    src="http://caestus.ma/uploads/media/3HlaM37RsHHaJBoQNmLM.jpg"></a>
                        ...
                        <ul class="list-of-products-img" id='underlightgallery'>
                            ...
                            <a href="http://caestus.ma/uploads/media/3HlaM37RsHHaJBoQNmLM.jpg" class='kj'> <img
                                    src="http://caestus.ma/uploads/media/3HlaM37RsHHaJBoQNmLM.jpg"></a>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="tab-content p-4">
                            <div class="tab-pane fade show active" id="tab-home-1">
                                ...
                                <p>
                                <p>Caestus Studios met à votre disposition un opérateur <a
                                        href="https://caestus.ma/product/87/">Steadicam</a> professionnel qui se déplace
                                    sur votre lieu de tournage.</p>.</p>
                            </div>
                            ...
                            <div class="container">
                                <div class="row text-center">
                                    <a href='javascript:;' class=" btn add-To-Cart-Big" data-category="prestation"
                                        data-image='http://caestus.ma/uploads/media/3HlaM37RsHHaJBoQNmLM.jpg'
                                        id='addToCartBtn' data-name='Opérateur Steadicam' data-id='8'>
                                        AJOUTER AU DEVIS
                                    </a>
                                </div>
                            </div>
